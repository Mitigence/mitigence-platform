    ...
    <div className="min-h-[172px] md:min-h-[224px] flex items-center mb-6">
      <AnimatePresence mode="wait">
        ...
        {slide === 2 && (
          ...
          >
            {'M'}
            <span style={{ background: 'linear-gradient(to bottom, #dc2626 0%, #dc2626 35%, #ffffff 35%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>i</span>
            {'t'}
            <span style={{ background: 'linear-gradient(to bottom, #dc2626 0%, #dc2626 35%, #ffffff 35%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>i</span>
            {'gence'}
          </motion.h1>
