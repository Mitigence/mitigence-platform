...
export const metadata: Metadata = {
  ...
  description: "The pathways remote and hybrid workforces use to reach internal systems. Discovery, assessment, engineering, and continuous improvement.",
  ...
  return (
    <main className="min-h-screen pt-24 bg-black">
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <p className="text-zinc-400 text-lg mb-12 leading-relaxed">The pathways remote and hybrid workforces use to reach internal systems.</p>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-10">
          <div>
            <h2 className="text-white font-semibold text-xs uppercase tracking-wide mb-4">Common challenges</h2>
            <ul className="space-y-3">
              <li className="flex items-start gap-2 text-zinc-400 text-sm"><span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-red-600 flex-shrink-0" />Legacy VPN architectures with broad network trust</li>
              <li className="flex items-start gap-2 text-zinc-400 text-sm"><span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-red-600 flex-shrink-0" />Inconsistent device posture checks</li>
              <li className="flex items-start gap-2 text-zinc-400 text-sm"><span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-red-600 flex-shrink-0" />Limited session monitoring</li>
          ...
          <div>
            ...
            <p className="text-zinc-400 text-sm leading-relaxed">Remote access is the front door for a distributed workforce — and a frequent target for credential-based attacks.</p>
          </div>
        </div>
